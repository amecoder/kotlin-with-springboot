...
/**
 * DTO for {@link com.example.demo.member.entity.Member}
 */
data class MemberSignupRequestDto(
    ...
    private val _brithDate: String?,

    @field:NotBlank
    @field:ValidEnum(
        enumClass = Gender::class,
        message = "MALE 이나 FEMALE 중 하나를 선택해주세요"
    )
    ...
    val brithDate: LocalDate
        get() = LocalDate.parse(_brithDate!!, DateTimeFormatter.ofPattern("yyyy-MM-dd"))
    val gender: Gender
    ...
    fun toEntity(): Member =
        Member(id, loginId, password, name, brithDate, gender, email)
}